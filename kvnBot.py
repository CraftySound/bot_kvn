...
# Вопросы и ответы
questions = [
    {"question": "В каком году стартовала телевизионная Премьер-Лига КВН?", "options": ["2001", "2002", "2003", "2004"],
     "correct": 2},
    {"question": "Кто не становился чемпионом Первой Лиги КВН?", "options": ["Сборная Забайкальского края", "Евразия", "Плюшки", "Ингеборга Дапкунайте"],
     "correct": 2},
    ...
    {"question": "По мнению команды КВН Станция Спортивная, именно он убийца.",
     ...
     "correct": 1},
    {"question": "Какая команда стала первым чемпионом возрождённого КВН?",
